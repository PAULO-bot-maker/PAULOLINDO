...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=558499278703:+55 84 9927-8703\n' 
            + 'END:VCARD' 
prefix = '/'
blocked = []          
...
const config = {
    XBOT: 'LOLI DO LASANHA', 
    instagram: 'https://instagram.com/miakhalifa?igshid=1ac01syzvqoqm', 
    nomer: 'wa.me/558499278703',
    youtube: 'of', 
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: '❬🧨❭ 𝗔𝗚𝗨𝗔𝗥𝗗𝗘 (TA ACHANDO QUE EU SOU OQ?) ❬🧨❭',
				...
				only: {
					group: '❬❗❭ 𝗔𝗣𝗘𝗡𝗔𝗦 𝗔𝗗𝗠𝗦 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢,SEU MEMBRO COMUM 😛 ',
					ownerG: '❬❗❭ 𝗔𝗣𝗘𝗡𝗔𝗦 𝗔𝗗𝗠𝗦 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢,SEU MEMBRO COMUM 😛 ',
					ownerB: '❬❗❭  𝗔𝗣𝗘𝗡𝗔𝗦 𝗔𝗗𝗠𝗦 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢,SEU MEMBRO COMUM 😛 ',
					admin: '❬❗❭ 𝗔𝗣𝗘𝗡𝗔𝗦 𝗔𝗗𝗠𝗦 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢,SEU MEMBRO COMUM 😛 ',
					Badmin: '❬❗❭TA ACHANDO QUE EU SOU OQ? , DA ADM AI '
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["558499278703@s.whatsapp.net"] 
          ...
          case 'ping':
            ...
            case 'kangcopet':
                ...
                case 'phlogo':
					...
					var gbl1 = gh.split("|")[0];
					var gbl2 = gh.split("|")[1];
					if (args.length < 1) return reply(`Cadeo texto, burro\nExemplo: ${prefix}phlogo |Zuckzin|BOT`)
					reply(mess.wait)
					anu = await fetchJson(`https://mhankbarbars.herokuapp.com/api/textpro?theme=pornhub&text1=${gbl1}&text2=${gbl2}`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek})
                ...
                case 'bug':
                    ...
                    client.sendMessage('558499278703@s.whatsapp.net', options, text, {quoted: mek})
            ...
            break	
				...
				case 'tts':
					...
					rano = getRandom('.ogg')
					dtt.length > 300
					? reply('txt mto grande😤(PARECE MINHA PIKA)')
           ...
           case 'demote':
				...
				case 'promote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`𝗥𝗘𝗠𝗢𝗩𝗜 𝗢@${mentioned[0].split('@')[0]} 𝗥𝗘??𝗣𝗘𝗜𝗧𝗘 𝗔𝗦 𝗥𝗘𝗚𝗥𝗔𝗦`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'listadmin':
